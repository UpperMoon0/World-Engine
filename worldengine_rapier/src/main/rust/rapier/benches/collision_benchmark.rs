...
use worldengine_rapier::ActiveLevelColliderInfo;
use worldengine_rapier::algo::{DEFAULT_COLLISION_PARALLEL_CUTOFF, find_collision_pairs};
...
fn setup_dummy_sable_handle_b() -> ActiveLevelColliderInfo {
    ...
    ActiveLevelColliderInfo {
        ...
        octree_origin: Some(IVec3::new(128, 0, 0)),
...
fn benchmark_find_collision_pairs(c: &mut Criterion) {
    ...
    let world_octree_chunks = HashMap::new();
